...
import { FaUser, FaEnvelope, FaLink, FaLock, FaUserPlus, FaEye, FaEyeSlash } from 'react-icons/fa';
...
const RegisterPage = () => {
    ...
    const handleGoogleSignIn = async () => {
        try {
            await authClient.signIn.social({
                ...
                onSuccess: () => {
                    toast.success("Welcome! Signed in with Google securely.", toastConfig);
                },
                onError: (ctx) => {
                    toast.error(ctx.error.message || "Google Sign-In failed.");
                }
    ...
    return (
        <main className="min-h-screen bg-base-100 flex items-center justify-center px-4 py-12">
            <div className="w-full max-w-105 bg-white border border-slate-100 rounded-3xl p-8 shadow-[0_8px_32px_rgba(0,0,0,0.02)] space-y-6">
                ...
                <div className="flex flex-col items-center text-center space-y-2">
                    ...
                    <p className="text-xs text-slate-500 font-medium">
                        Join the university library network platform
                    </p>
                </div>
                ...
                <div className="relative flex py-2 items-center text-slate-300">
                    ...
                    <span className="shrink mx-4 text-[10px] font-bold uppercase tracking-widest text-slate-400">or join with</span>
                    <div className="grow border-t border-slate-100"></div>
                </div>
